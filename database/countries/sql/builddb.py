...
create_statement = '''CREATE TABLE countries (name text, alpha_2 text, alpha_3 text)'''

insert_statement = '''INSERT INTO countries VALUES (?,?,?)'''

country_list = [('Afghanistan', 'af', 'afg'),
...
conn.executemany(insert_statement, country_list)
conn.commit()
conn.close()